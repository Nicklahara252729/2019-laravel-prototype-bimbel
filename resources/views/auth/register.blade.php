...
@section('css')
<!-- SPECIFIC CSS -->
<link href="{{asset('assets/landing-page/css/skins/square/grey.css')}}" rel="stylesheet">
<link href="{{asset('assets/landing-page/css/wizard.css')}}" rel="stylesheet">
@endsection
@section('main')
...
@section('js')
<!-- SPECIFIC SCRIPTS -->
    <script src="{{asset('assets/landing-page/js/jquery-ui-1.8.22.min.js')}}"></script>
	<script src="{{asset('assets/landing-page/js/jquery.wizard.js')}}"></script>
	<script src="{{asset('assets/landing-page/js/jquery.validate.js')}}"></script>
	<script src="{{asset('assets/landing-page/js/admission_func.js')}}"></script>
@endsection