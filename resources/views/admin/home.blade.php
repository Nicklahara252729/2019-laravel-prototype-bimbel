              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="{{asset('assets/admin/images/faces/face4.jpg')}}" alt="">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="{{asset('assets/admin/images/faces/face5.jpg')}}" alt="">
                    <div class="wrapper w-100 ml-3">
                      <p class="mb-0">
                  ...
                  <div class="list d-flex align-items-center border-bottom py-3">
                    <img class="img-sm rounded-circle" src="{{asset('assets/admin/images/faces/face7.jpg')}}" alt="">
                    <div class="wrapper w-100 ml-3">
                      <p class="mb-0">
                  ...
                  <div class="list d-flex align-items-center pt-3">
                    <img class="img-sm rounded-circle" src="{{asset('assets/admin/images/faces/face6.jpg')}}" alt="">
                    <div class="wrapper w-100 ml-3">
                      <p class="mb-0">
