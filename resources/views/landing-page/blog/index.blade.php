...
@section('css')
<!-- SPECIFIC CSS -->
<link href="{{asset('assets/landing-page/css/blog.css')}}" rel="stylesheet">
@stop
@section('main')
				...
				<div class="col-lg-9">
					<article class="blog wow fadeIn">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="{{url('blog/view')}}"><img src="http://via.placeholder.com/800x533/ccc/fff/blog-1.jpg" alt="">
							...
							<div class="col-lg-5">
								<div class="post_info">
									...
									<h3><a href="{{url('blog/view')}}">Nec nihil menandri appellantur ut</a></h3>
					...
					<article class="blog wow fadeIn">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="{{url('blog/view')}}"><img src="http://via.placeholder.com/800x533/ccc/fff/blog-2.jpg" alt="">
										<div class="preview"><span>Read more</span></div>
									</a>
								</figure>
							</div>
					...
					<article class="blog wow fadeIn">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="{{url('blog/view')}}"><img src="http://via.placeholder.com/800x533/ccc/fff/blog-3.jpg" alt="">
										<div class="preview"><span>Read more</span></div>
									</a>
								</figure>
							</div>
					...
					<article class="blog wow fadeIn">
						<div class="row no-gutters">
							<div class="col-lg-7">
								<figure>
									<a href="{{url('blog/view')}}"><img src="http://via.placeholder.com/800x533/ccc/fff/blog-4.jpg" alt="">
										<div class="preview"><span>Read more</span></div>
									</a>
								</figure>
							</div>
