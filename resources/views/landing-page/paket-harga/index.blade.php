...
@section('css')
<link href="{{asset('assets/landing-page/css/tables.css')}}" rel="stylesheet">
@stop
@section('main')
...
@section('js')
<!-- SPECIFIC SCRIPTS -->
<script src="{{asset('assets/landing-page/js/modernizr_tables.js')}}"></script>
<script src="{{asset('assets/landing-page/js/tables_func.js')}}"></script>
@stop